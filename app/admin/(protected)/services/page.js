...
export default async function AdminServicesPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-display font-bold text-brand-blue">Gestion des services</h1>
        <p className="text-brand-gray-500 mt-1">Ajoutez, modifiez ou supprimez les services affichés sur le site.</p>
      </div>
