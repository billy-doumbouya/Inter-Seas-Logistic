...
const WELCOME = 'Bonjour ! Je suis ARIA, l\'assistante virtuelle d\'Inter Seas Logistic. Comment puis-je vous aider aujourd\'hui ?'
...
export default function Chatbot() {
  ...
  const send = async () => {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { role: 'assistant', content: 'Désolé, une erreur est survenue. Réessayez ou contactez-nous au +224 664 20 80 80.' }])
    } finally {
      setLoading(false)
    }
  }
          ...
          >
            ...
            <div className="bg-brand-blue px-5 py-4 flex items-center justify-between flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold text-sm">Assistant ARIA</p>
                  ...
                  <div className="bg-white shadow-sm rounded-2xl rounded-tl-sm px-4 py-3 flex items-center gap-1">
                    {[0, 0.2, 0.4].map((d) => (
                      <motion.span
                        ...
                        transition={{ repeat: Infinity, delay: d, duration: 0.8 }}
